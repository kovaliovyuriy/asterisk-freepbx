#!/bin/bash
clear
# Скрипт встановлення FreePBX 14 і Asterisk 13 на CentOS 7
echo "                                                           "
echo "======================================================================================="
echo "# Скрипт встановлення FreePBX 14 і Asterisk 13 на CentOS 7"
echo "# Версія 1.0"
sleep 10
...
echo ""
cowsay "ОНОВЛЕННЯ ОПЕРАЦІЙНОЇ СИСТЕМИ"
echo ""
sleep 5
yum -y update
clear
echo ""
cowsay "ВСТАНОВЛЕННЯ КОРИСНИХ ІНСТРУМЕНТІВ..."
echo ""
sleep 5
...
clear
echo ""
cowsay "ВСТАНОВЛЕННЯ ASTERISK 13"
echo ""
sleep 5
cd /usr/src
...
clear
echo ""
cowsay "ДОДАВАННЯ FREEPBX ДО АВТОЗАВАНТАЖЕННЯ"
echo ""
sleep 5
echo "[Unit]" > /etc/systemd/system/freepbx.service
echo "Description=Сервер VoIP - FreePBX" >> /etc/systemd/system/freepbx.service
...
clear
echo ""
cowsay "Встановлення АУДІО потрібною мовою"
echo ""
sleep 5
...
clear
echo ""
cowsay "Встановлення CODEC G729"
echo ""
sleep 5
 ...
 clear
echo ""
cowsay "ВСТАНОВЛЕННЯ TRATAMENTO HANGUPCAUSE"
echo ""
sleep 5
...
clear
echo ""
cowsay "ЗАВАНТАЖЕННЯ І ВСТАНОВЛЕННЯ ОСЕНОВНИХ МОДУЛІВ"
echo ""
sleep 5
...
echo -e "\033[40;31mSeu FreePBX установлен. Войдите, используя свой браузер и IP-адрес сервера, чтобы продолжить настройки! \033[1m"
echo -e "\033[40;31m======================================================================================================================================== \033[1m"
echo -e "\033[40;31mSВАША СИСТЕМА перезапустится через 15 с.
 (НАЖМИТЕ CTRL + C, ЧТОБЫ ПЕРЕЗАПУСТИТЬ ВРУЧНУЮ) \033[1m"
